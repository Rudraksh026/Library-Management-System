<?php
    echo '<header class="text-gray-600 body-font">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a href="index.php" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span class="ml-3 text-xl">LMS</span>
        </a>
        <nav
            class="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray-400	flex flex-wrap items-center text-base justify-center">
            <a href="search.php" class="mr-5 hover:text-gray-900">Search Book</a>
            <a href="issuebook.php" class="mr-5 hover:text-gray-900">Issue Book</a>
            <a href="returnbook.php" class="mr-5 hover:text-gray-900">Return Book</a>
